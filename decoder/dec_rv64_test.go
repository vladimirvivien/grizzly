	...
	}{
		{
			...
			setup: func(t *testing.T) datapath.Bytestream {
				...
				go func() {
					...
					// RI
					inst = datapath.EncodeInstruction(datapath.Instruction{PC: 8, Inst: 0b010001000010_00001_110_00101_0010011})
					stream <- inst

					// Load
					inst = datapath.EncodeInstruction(datapath.Instruction{PC: 16, Inst: 0b100010001011_01011_101_00101_0000011})
					stream <- inst

					// Store
					inst = datapath.EncodeInstruction(datapath.Instruction{PC: 24, Inst: 0b0010100_11011_01001_010_00101_0100011})
					stream <- inst

					// Branch
					inst = datapath.EncodeInstruction(datapath.Instruction{PC: 32, Inst: 0b0_000100_10011_00001_000_1010_1_1100011})
					stream <- inst
